          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded overflow-hidden shadow-md group">
                ...
                <div className="p-6">
                  <h3 className="font-serif text-xl text-charcoal-800 mb-1">Patricia Dogbegah</h3>
              ...
              <div className="bg-white rounded overflow-hidden shadow-md group">
                ...
                <div className="p-6">
                  <h3 className="font-serif text-xl text-charcoal-800 mb-1">Barima</h3>
                  <p className="text-gold-600 mb-3">Director of Inland Estates</p>
                  <p className="text-slate-600">
                    Barima specializes in exclusive inland properties, with particular expertise in 
