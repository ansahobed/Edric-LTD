              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">No. 1 Quail Link Comm. 17 , Tema</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">
                      <a href="tel:+233244158119 /+233303409426" className="hover:text-gold-500 transition-colors">
                        (233)-24-415-8119 / (233)30-340-9426
                      </a>
                    </p>
                  </div>
                </div>
